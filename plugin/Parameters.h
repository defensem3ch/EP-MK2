...
inline const std::vector<Spec>& table()
{
    static const std::vector<Spec> t = {
        ...
        { "bend_range",      "Pitch Bend Range", "Output", Unit::Semitones,  0.0f,    24.0f,    2.0f, false,
          ...
          "Bend Range" },
        { "pitch_bend",      "Pitch Bend",      "Output", Unit::Ratio,     -1.0f,     1.0f,    0.0f, false,
          "Where the pitch wheel is. It follows an incoming MIDI wheel and can be driven from here instead, and how far it reaches is Bend Range beside it. A real wheel is sprung and this is not, so it stays where it is put.",
          "Bend" },
